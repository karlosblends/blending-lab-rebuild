...
export const projects = [
  ...
  },
  {
    ...
    gallery: [
      ...
      projectAsset("visit-sibenik", "gallery-02.jpg"),
      projectAsset("visit-sibenik", "gallery-03.jpg"),
      projectAsset("visit-sibenik", "gallery-04.jpg"),
      projectAsset("visit-sibenik", "gallery-05.jpg"),
    ],
    featured: true,
    archived: false,
  ...
  "visit-sibenik": {
    ...
    sections: [
      ...
      },
      {
        ...
        alt: "Visit Šibenik story discovery section with fortress, cathedral, and UNESCO editorial cards",
        caption: "Story-led discovery gives the city's landmarks context before asking the visitor to plan around them.",
      },
      {
        type: "statement",
      ...
      {
        type: "fullImage",
        image: projectAsset("visit-sibenik", "gallery-02.jpg"),
        alt: "Visit Šibenik experience carousel with culture, heritage, nature, and activity cards",
        caption: "Experience cards turn the breadth of the destination into browsable, actionable choices.",
      },
      {
        type: "textImage",
        ...
        image: projectAsset("visit-sibenik", "gallery-03.jpg"),
        alt: "Visit Šibenik call to action and structured destination footer over a cinematic night scene",
        caption: "The visual language stays present through utility-heavy surfaces and the final call to action.",
        align: "left",
        scale: "wide",
      },
      {
      ...
      },
      {
        ...
        images: [
          {
            src: projectAsset("visit-sibenik", "gallery-04.jpg"),
            alt: "Visit Šibenik destination detail page with practical trip metadata beside editorial content",
            caption: "Practical visit data sits next to the story, exactly where it affects the decision.",
          },
          {
            src: projectAsset("visit-sibenik", "gallery-05.jpg"),
            alt: "Visit Šibenik mobile layouts for Šibenik Card and featured events",
            caption: "Mobile preserves the editorial hierarchy across product, event, and planning surfaces.",
          },
        ],
      },
      {
